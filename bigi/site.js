...
(function(){
  ...
  function whatsappLink(vendor, message){
    const msg = encodeURIComponent(message || `שלום ${vendor.name}, מצאתי אתכם בספקים קלאב ורציתי לשאול לגבי זמינות ומחיר ל${vendor.tag}.`);
  ...
  function initJoinPage(){
    ...
    if(!form) return;
    const extrasEditor = window.mountExtrasEditor($('#extras-editor'));
