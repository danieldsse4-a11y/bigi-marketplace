...
const CATEGORIES = [
  ...
  { id: "attractions", name: "אטרקציות לאירועים",  icon: "🎡", count: 64,  grad: "g6", keywords: "אטרקציה אטרקציות מתנפחים מתקנים קרוסלה סימולטור ג'אמפינג מתחם משחקים פעילות ילדים" },
  { id: "barbers",  name: "ספרים לאירועים",        icon: "💈", count: 47,  grad: "g7", keywords: "ספר ספרים מספרה תספורת עיצוב שיער גילוח זקן חתן בר מצווה" },
];
