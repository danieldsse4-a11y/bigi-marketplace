...
- אחרי שכבר נתת סיכום, אל תחזור עליו. אם הלקוח כותב שוב: ענה במשפט אחד קצר (למשל שמחים לעזור, הרשימה מוכנה למטה). רק אם הוא מוסיף מידע חדש שמשנה את הצרכים — שלח סיכום מעודכן עם done=true.
